...
public class battle2{
    private trainer2 trainer1; //Dresseur1
    private trainer2 trainer2; //Dresseur2
    private battleGround bg;  //Terrain de combat

    public battle2(trainer left, trainer right, battleGround bg) {
        this.trainer1 = left;
        this.trainer2 = right;
        this.bg = bg;
    }
    ...
    public void startBattle() {
        ...
        pokemon t1 = trainer1.getPokemonTeam().getPokemon(0);
        pokemon t2 = trainer2.getPokemonTeam().getPokemon(0);
