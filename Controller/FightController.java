...
public class FightController implements Initializable {
    ...
    @FXML
    private ImageView battleGround;

    @FXML
    private ImageView imageCurrPkm;
    @FXML
    private Label nameCurrPkm;
    @FXML
    private ProgressBar pvCurrPkm;
    @FXML
    private Label pvLabelCurrPkm;
    @FXML
    private ImageView statusCurrPkm;

    @FXML
    private ImageView imageOppPkm;
    @FXML
    private Label nameOppPkm;
    @FXML
    private ProgressBar pvOppPkm;
    @FXML
    private Label pvLabelOppPkm;
    @FXML
    private ImageView statusOppPkm;
...
//	@FXML	private Label nameP1;
    ...
    @FXML
    private Label nameP5;
    @FXML
    private ImageView p6;
    @FXML
    private Label nameP6;

    @FXML
    private ImageView a1;
    @FXML
    private Label nameA1;
    @FXML
    private ImageView a2;
    @FXML
    private Label nameA2;
    @FXML
    private ImageView a3;
    @FXML
    private Label nameA3;
    @FXML
    private ImageView a4;
    @FXML
    private Label nameA4;

    @FXML
    private GridPane gridChoice;
    @FXML
    private GridPane gridFight;
    @FXML
    private AnchorPane backgroundFight;

    @FXML
    private HBox attackHbox;
    @FXML
    private HBox pokemonHbox;
