...
public class ClientExemple {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            var carchacrok = new Pokemon("Carchacrok", PokeTypes.type.DRAGON, PokeTypes.type.GROUND, 50, 108, 130, 95, 80, 85, 102,0,0,0,0,0,0,"HARDY", dracocharge, dracogriffe, seisme, lanceflammes, 445);
            var metalosse = new Pokemon("Metalosse", PokeTypes.type.STEEL, PokeTypes.type.PSYCHIC, 50, 80, 135, 130, 95, 90, 70,0,0,0,0,0,0,"HARDY", poingmeteor, seisme, poingglace, poingeclair, 376);
            var tyranocif = new Pokemon("Tyranocif", PokeTypes.type.ROCK, PokeTypes.type.DARK, 50, 100, 134, 110, 95, 100, 61,0,0,0,0,0,0,"HARDY", lamederock, poingfeu, seisme, machouille, 248);
            var togekiss = new Pokemon("Togekiss", PokeTypes.type.FAIRY, PokeTypes.type.FLYING, 50, 85, 50, 95, 120, 115, 80,0,0,0,0,0,0,"HARDY", lamedair, eclatmagique, ballombre, lanceflammes, 468);
            var elekable = new Pokemon("Elekable", PokeTypes.type.ELECTRIC, null, 50, 75, 123, 67, 95, 85, 95,0,0,0,0,0,0,"HARDY", poingeclair, poingfeu, poingglace, seisme, 446);
            var pingoleon = new Pokemon("Pingoléon", PokeTypes.type.WATER, PokeTypes.type.STEEL, 50, 84, 86, 88, 111, 101, 60,0,0,0,0,0,0,"HARDY", surf, hydrocanon, luminocanon, laserglace, 395);
