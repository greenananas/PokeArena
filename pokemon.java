...
public class pokemon {
     ...
     */
    public pokeTypes.type getType1(){return this.type1;}
     ...
     * @return Type du Pokémon
     */
    public pokeTypes.type getType2(){return this.type2;}
     ...
     */
    public int getFullHP(){return this.fullhp;}
     ...
     */
    public int getSpeAttack(){return this.speAttack;}
     ...
     */
    public int getSpeDefense(){return this.speDefense;}
     ...
     */
    public attack getAttack1(){return this.attack1;}
     ...
     */
    public attack getAttack2(){return this.attack2;}
     ...
     */
    public attack getAttack3(){return this.attack3;}
     ...
     */
    public attack getAttack4(){return this.attack4;}
     ...
     */
    public pokeStatus.status getStatus(){return this.status;}
     ...
     */
    public void setType1(pokeTypes.type t){this.type1=t;}
     ...
     * @param t Nouveau type du Pokémon
     */
    public void setType2(pokeTypes.type t){this.type2=t;}
     ...
     */
    public void setFullHP(int hp){this.fullhp=hp;}
     ...
     */
    public void setDefense(int a){this.defense=a;}
     ...
     */
    public void setSpeAttack(int a){this.speAttack=a;}
     ...
     */
    public void setSpeDefense(int a){this.speDefense=a;}
     ...
     */
    public void setAttack1(attack a){this.attack1=a;}
     ...
     */
    public void setAttack2(attack a){this.attack2=a;}
     ...
     */
    public void setAttack3(attack a){this.attack3=a;}
     ...
     */
    public void setAttack4(attack a){this.attack4=a;}
     ...
     */
    public void setEvasion(int e){this.evasion=e;}
     ...
     */
    public void setStatus(pokeStatus.status s){this.status=s;}
     ...
     * @param c Confus
     */
    public void setConfused(boolean c){this.confused=c;}
     ...
     */
    public boolean isKO(){return this.getHP()<=0;}
    ...
    public boolean isStabbed(attack a){
        if(this.getType1()==a.getType()){return true;}
        else if(this.getType2()!=null){if(this.getType2()==a.getType()){return true;}}
        return false;
    }
    ...
    public boolean doesHit(pokemon target,attack at){
        ...
        if(precision<=at.getPrecision()){return true;}
        return false;
    }
    ...
    public int getHitDamage(pokemon target,attack at){
        ...
        if(typeMultiplier>1){System.out.println("\nC'est super efficace!");}
        else if(typeMultiplier<1){System.out.println("\nCe n'est pas très efficace...");}
        
        double stabMultiplier=1;
        if(this.isStabbed(at)){stabMultiplier=1.5;}

        double critMultiplier=1;
        if(isCritical(at)){critMultiplier=1.5;}

        double burntMultiplier=1;
        if(this.getStatus()==pokeStatus.status.BURNT && at.isPhysical()){burntMultiplier=0.5;}
    ...
    public double getTypeMultiplier(attack at){
        double typeMultiplier=pokeTypes.getTypeAdvantage(this.getType1(),at.getType()).getEffect();
        if(this.getType2()!=null){typeMultiplier*=pokeTypes.getTypeAdvantage(this.getType2(),at.getType()).getEffect();}
    ...
    public boolean isCritical(attack at){
        ...
        if(this.getCritStage(at)==1){critProb=1/8;}
        if(this.getCritStage(at)==2){critProb=1/2;}
        if(this.getCritStage(at)==3){critProb=1;}

        double critRandom=(int) Math.floor(Math.random());
        if(critRandom<critProb){System.out.println("\nCoup critique!");return true;}
        return false;
    }
